...
CREATE TABLE reports (
    ...
    file_size INT,
    file_type ENUM('document', 'image', 'video') DEFAULT 'document',
...
CREATE TABLE system_logs (
    id INT AUTO_INCREMENT PRIMARY KEY,
    user_id INT,
    user_type ENUM('student', 'teacher', 'school', 'admin'),
...
-- Insert sample students and teachers
-- Default password: "password123"
...
INSERT INTO users (username, email, password, first_name, last_name, role, teacher_id, school_id) VALUES
('teacher1', 'prof.garcia@teacher.edu', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Maria', 'Garcia', 'teacher', 'TCH2024001', 1),
('teacher2', 'prof.martinez@teacher.edu', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Carlos', 'Martinez', 'teacher', 'TCH2024002', 2),
('teacher3', 'prof.lopez@teacher.edu', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Ana', 'Lopez', 'teacher', 'TCH2024003', 3);

-- Insert sample reports
INSERT INTO reports (title, description, student_id, school_id, file_name, file_type, status, submission_date) VALUES
('AI Implementation in Healthcare', 'A comprehensive study on artificial intelligence applications in modern healthcare systems, focusing on diagnostic accuracy and patient outcomes.', 1, 1, 'ai_healthcare_report.pdf', 'document', 'approved', '2024-01-15 10:30:00'),
('Sustainable Energy Solutions', 'Research on renewable energy integration in rural communities, examining solar and wind power feasibility.', 2, 2, 'sustainable_energy.pdf', 'document', 'under_review', '2024-02-20 14:15:00'),
('Digital Marketing Strategies', 'Analysis of social media marketing effectiveness for small businesses in the digital age.', 3, 1, 'digital_marketing.pdf', 'document', 'submitted', '2024-03-10 09:45:00'),
('Cybersecurity Best Practices', 'Investigation of current cybersecurity threats and recommended protection strategies for organizations.', 4, 3, 'cybersecurity_study.pdf', 'document', 'revision_required', '2024-02-28 16:20:00'),
('Environmental Impact Assessment', 'Study on the environmental effects of industrial development in coastal areas.', 5, 4, 'environmental_impact.pdf', 'document', 'approved', '2024-01-25 11:10:00');